...
public class PlazoFijo {
    ...
    private Double tasa(){
       // Agregar en la clase PlazoFijo el método privado “calcularTasa()” que retorna el
       // valor doble que corresponde a la tasa de interés de acuerdo, al monto y plazo
       // del Plazo Fijo.
